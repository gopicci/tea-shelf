# Generated by Django 3.0.6 on 2020-07-01 01:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('weight', models.FloatField(blank=True, default=5, null=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('temperature', models.PositiveSmallIntegerField(blank=True, default=99, null=True, validators=[django.core.validators.MaxValueValidator(100)])),
                ('weight', models.FloatField(blank=True, default=1, null=True, validators=[django.core.validators.MinValueValidator(0)])),
        ...
        migrations.AddField(
            model_name='tea',
            name='vendor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='catalog.Vendor'),
        ),
        migrations.AddField(
            model_name='tea',
        ...
        migrations.AddConstraint(
            model_name='origin',
            constraint=models.UniqueConstraint(fields=('country', 'region', 'locality'), name='unique_origin'),
        ),
        migrations.AddConstraint(
            model_name='origin',
            constraint=models.UniqueConstraint(condition=models.Q(locality=None), fields=('country', 'region'), name='unique_region_origin'),
        ),
        migrations.AddConstraint(
            model_name='origin',
            constraint=models.UniqueConstraint(condition=models.Q(region=None), fields=('country', 'locality'), name='unique_locality_origin'),
        ),
    ]
