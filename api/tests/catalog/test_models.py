...
from catalog.models import CustomUser, GongfuBrewing, WesternBrewing, Origin, Category, Subcategory, SubcategoryName, Vendor, VendorTrademark
...
def test_gongfubrewing_model():
    brewing = GongfuBrewing(temperature=99,
                            weight=Decimal(5),
...
def test_gongfubrewing_model_validators():
    brewing = GongfuBrewing(temperature=101,
                            weight=Decimal(5),
                            initial=timedelta(seconds=10),
                            increments=timedelta(seconds=3))
    ...
    brewing1 = GongfuBrewing(temperature=99,
                             weight=Decimal(5),
                             initial=timedelta(seconds=10),
                             increments=timedelta(seconds=3))
    brewing1.save()
    ...
    brewing2 = GongfuBrewing(temperature=99,
                             weight=Decimal(5),
                             initial=timedelta(seconds=10),
                             increments=timedelta(seconds=3))
...
def test_westernbrewing_model():
    brewing = WesternBrewing(temperature=85,
                             weight=Decimal(0.8),
...
def test_westernbrewingg_model_validators():
    brewing = WesternBrewing(temperature=101,
                             weight=Decimal(0.8),
                             initial=timedelta(seconds=180))
    ...
    brewing1 = WesternBrewing(temperature=85,
                              weight=Decimal(2),
                              initial=timedelta(seconds=180))
    brewing1.save()
    ...
    brewing2 = WesternBrewing(temperature=85,
                              weight=Decimal(2),
                              initial=timedelta(seconds=180))
    with pytest.raises(IntegrityError):
        brewing2.save()
...
def test_category_model():
    gongfu = GongfuBrewing(temperature=99,
                           ...
                           increments=timedelta(seconds=3))
    gongfu.save()
    western = WesternBrewing(temperature=85,
                             weight=Decimal(0.8),
                             initial=timedelta(seconds=180))
    western.save()
...
def test_subcategory_subcategoryname_model():
    ...
    subcategoryname = SubcategoryName(subcategory=subcategory,
                                      name='dhp')
...
def test_vendor_vendortrademark_model():
    ...
    vendor_tm = VendorTrademark(vendor=vendor,
                                name='vn')
    vendor_tm.save()
